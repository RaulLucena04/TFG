...
public class TeamDetailController {
    ...
    @FXML private Label lblTeamName, lblConference, lblDivision, lblRecord;
    @FXML private Label lblPPG, lblRPG, lblAPG;

    @FXML private TableView<Jugador> tablePlayers;
    @FXML private TableColumn<Jugador, String> colPlayerName, colPlayerPosition;
    @FXML private TableColumn<Jugador, Integer> colPlayerNumber;
    @FXML private TableColumn<Jugador, Double> colPlayerPPG, colPlayerRPG, colPlayerAPG;

    @FXML private TableView<Partido> tableRecentMatches;
    @FXML private TableColumn<Partido, String> colMatchDate, colMatchRival, colMatchResult;

...
public final class FragmentMatchesBinding implements ViewBinding {
  ...
  private FragmentMatchesBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView recyclerViewMatches, @NonNull Spinner spinnerFilter) {
  ...
  public static FragmentMatchesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMatchesBinding((ConstraintLayout) rootView, recyclerViewMatches,
          spinnerFilter);
    }

...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnRegister,
      ...
      @NonNull TextInputLayout tilUsername, @NonNull TextView tvLogin, @NonNull TextView tvSubtitle,
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((ConstraintLayout) rootView, btnRegister,
          etConfirmPassword, etEmail, etPassword, etUsername, progressBar, tilConfirmPassword,
          tilEmail, tilPassword, tilUsername, tvLogin, tvSubtitle, tvTitle);
    }
